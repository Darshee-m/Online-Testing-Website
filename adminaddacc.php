...
<html>
	...
	<body>
		<div id="header">
			...
			<form onsubmit="return checkForm(this);" action="adminaddacc2.php" method="POST" style="margin-left:40px; font-size:18px;"><br>
				Email &nbsp &nbsp &nbsp &nbsp <input type="text" placeholder="Email" name="email"><br><br>
				User type &nbsp &nbsp &nbsp &nbsp
				<select name="usertype" class="user-type" >
