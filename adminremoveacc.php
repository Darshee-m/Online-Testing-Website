	...
	<body>
		<div id="header">
    		...
    		<div id="container">
        		...
        		<div class="sidebar">
            		<ul id="nav" style="font-size:18px;">
                		...
                		<li>
                    			<a class="selected" href="#">Remove Account</a>
                		</li>
				<li>
        	...
        	<div class="content">
            		...
            		<h2 style="margin-left:40px;">Remove Account from Somaiya KJSCE Group</h2>
			<form action="adminactivity.php" method="POST" style="margin-left:40px; font-size:18px;"><br>
				Email<br><input type="text" placeholder="Email" name="email"><br><br>
