...
<html>
	<head>
		<title>Set/Change reopening date</title>
	...
	<body>
		<div id="header">
    		...
    		<div id="container">
				...
				<li>
                    			<a class="selected" href="#">Set Re-open date</a>
                		</li>
            		</ul>
        	...
        	<div class="content">
            		...
            		<h2 style="margin-left:40px;">Set re-open date</h2>
			<form action="adminactivity.php" method="POST" style="margin-left:40px; font-size:18px;"><br>
			Set the counters to the reopening date <br>
